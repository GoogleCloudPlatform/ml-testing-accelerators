...
export METRIC_COLLECTION_CONFIG=`echo $METRIC_COLLECTION_CONFIG | base64 -d`
echo "Metrics collection config: $METRIC_COLLECTION_CONFIG"

export REGRESSION_TEST_CONFIG=`echo $REGRESSION_TEST_CONFIG | base64 -d`
echo "Regression test config: $REGRESSION_TEST_CONFIG"
