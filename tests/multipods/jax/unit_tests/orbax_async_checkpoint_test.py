...
with maps.Mesh(mesh.devices, mesh.axis_names):
  ...
  print("orbax_async_checkpoint_test: Attempting save...")
  mngr.save(0, to_save)
  print("orbax_async_checkpoint_test: Save successful!")

# Try to restore now
print("orbax_async_checkpoint_test: Attempting restore...!")
s2 = mngr.restore(0)
print("orbax_async_checkpoint_test: Restore successful!")

print("orbax_async_checkpoint_test: Test finished successfully")
