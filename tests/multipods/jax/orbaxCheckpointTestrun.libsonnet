...

{
  local syncDevicesTest = common.JaxTest + mixins.Functional {
    ...
    testScript:: |||
      ...
      python3 ml-testing-accelerators/tests/multipods/jax/unit_tests/orbax_checkpoint_test.py --bucket_path=gs://multipod-xlml-outputs${MODEL_DIR:4:500} --ckpt_dir=orbax-checkpoints
      exit 0
    ||| % self.scriptConfig,
  },
  local v4_16 = {
