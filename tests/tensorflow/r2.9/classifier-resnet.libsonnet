...

{
  ...
  configs: [
    ...
    resnet + v100x8 + convergence + timeouts.Hours(45) + { schedule: null },
    resnet + a100x4 + convergence + timeouts.Hours(24),
    ...
    resnet + v4_8 + convergence + common.tpuVm,
    ...
    resnet + v4_32 + convergence + common.tpuVm,
  ],
}
