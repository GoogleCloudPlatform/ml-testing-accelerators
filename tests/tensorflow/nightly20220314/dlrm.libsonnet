...

{
  ...
  configs: [
    ...
    dlrm + functional + v3_8 + tpuVm,
    dlrm + functional + v2_32 + tpuVm,
    dlrm + functional + v3_32 + tpuVm,
    dlrm + functional + cross_interaction + v2_8 + tpuVm,
    dlrm + functional + cross_interaction + v3_8 + tpuVm,
    dlrm + functional + cross_interaction + v2_32 + tpuVm,
    dlrm + functional + cross_interaction + v3_32 + tpuVm,
    dlrm + convergence + cross_interaction + v2_8 + tpuVm,
    dlrm + convergence + cross_interaction + v3_8 + tpuVm,
    dlrm + convergence + cross_interaction + v2_32 + tpuVm,
    dlrm + convergence + cross_interaction + v3_32 + tpuVm,
    dlrm + convergence + v3_8 + tpuVm,
    dlrm + convergence + v2_8 + tpuVm,
