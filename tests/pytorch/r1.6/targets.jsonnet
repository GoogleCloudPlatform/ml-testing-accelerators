...
# blogpost benchmarking
local huggingfaceBenchmarking = import "hf-lm.libsonnet";
local huggingfaceGpuBenchmarking = import "hf-lm-gpu.libsonnet";
...
std.flattenArrays([
  ...
  #tpu_mem.configs,
  huggingfaceBenchmarking.configs,
  huggingfaceGpuBenchmarking.configs,
])
